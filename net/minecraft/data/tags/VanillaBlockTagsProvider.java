...
public class VanillaBlockTagsProvider extends IntrinsicHolderTagsProvider<Block> {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(BlockTags.SMALL_FLOWERS).add(blocks).add(Blocks.CLOSED_EYEBLOSSOM);
        ...
        this.tag(BlockTags.FLOWERS).addTag(BlockTags.SMALL_FLOWERS).add(blocks1);
        this.tag(BlockTags.BEE_ATTRACTIVE).add(blocks).add(blocks1);
