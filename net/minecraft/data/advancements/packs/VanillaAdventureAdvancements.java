        ...
        VanillaRecipeProvider.smithingTrims()
            ...
            .forEach(
                trimTemplate -> builder.addCriterion(
                    "armor_trimmed_" + trimTemplate.id().location(), RecipeCraftedTrigger.TriggerInstance.craftedItem(trimTemplate.id())
                )
            );
        return builder;
    }
        ...
        VanillaRecipeProvider.smithingTrims()
            ...
            .forEach(
                resourceKey -> builder.addCriterion(
                    "armor_trimmed_" + resourceKey.location(), RecipeCraftedTrigger.TriggerInstance.craftedItem((ResourceKey<Recipe<?>>)resourceKey)
                )
            );
        return builder;
    }
