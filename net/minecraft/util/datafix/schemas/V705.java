...
public class V705 extends NamespacedSchema {
    ...
    public Map<String, Supplier<TypeTemplate>> registerEntities(Schema schema) {
        ...
        schema.register(map, "minecraft:commandblock_minecart", string -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(schema)));
        ...
        schema.register(map, "minecraft:enderman", string -> DSL.optionalFields("carried", References.BLOCK_NAME.in(schema), V100.equipment(schema)));
