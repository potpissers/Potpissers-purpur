...
public class JigsawRotationFix extends DataFix {
    ...
    private static Dynamic<?> fix(Dynamic<?> dynamic) {
        ...
        return optional.equals(Optional.of("minecraft:jigsaw")) ? dynamic.update("Properties", dynamic1 -> {
            String string = dynamic1.get("facing").asString("north");
            return dynamic1.remove("facing").set("orientation", dynamic1.createString(RENAMES.getOrDefault(string, string)));
        }) : dynamic;
    }
