...
public class BlockStateData {
    ...
    public static void register(int id, String fixedNBT, String... sourceNBTs) {
        ...
        for (String string : sourceNBTs) {
            Dynamic<?> dynamic1 = parse(string);
            String string1 = dynamic1.get("Name").asString("");
            ID_BY_OLD_NAME.putIfAbsent(string1, id);
