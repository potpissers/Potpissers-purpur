...
public class BuiltInLootTables {
    ...
    public static final Map<DyeColor, ResourceKey<LootTable>> SHEEP_BY_DYE = Util.make(
        new EnumMap<>(DyeColor.class), map -> makeDyeKeyMap((EnumMap<DyeColor, ResourceKey<LootTable>>)map, "entities/sheep")
    );
    ...
    public static final Map<DyeColor, ResourceKey<LootTable>> SHEAR_SHEEP_BY_DYE = Util.make(
        new EnumMap<>(DyeColor.class), map -> makeDyeKeyMap((EnumMap<DyeColor, ResourceKey<LootTable>>)map, "shearing/sheep")
    );
