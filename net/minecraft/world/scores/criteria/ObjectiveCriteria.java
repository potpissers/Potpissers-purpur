        ...
        if (objectiveCriteria != null) {
            ...
            return index < 0
                ...
                : BuiltInRegistries.STAT_TYPE
                    .getOptional(ResourceLocation.bySeparator(name.substring(0, index), '.'))
                    .flatMap(statType -> getStat((StatType<?>)statType, ResourceLocation.bySeparator(name.substring(index + 1), '.')));
        }
    }
