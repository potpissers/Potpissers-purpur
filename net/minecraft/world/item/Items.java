...
public class Items {
    ...
    public static final Item TURTLE_HELMET = registerItem(
        "turtle_helmet", properties -> new ArmorItem(ArmorMaterials.TURTLE_SCUTE, ArmorType.HELMET, properties)
    );
    ...
    public static final Item CHAINMAIL_LEGGINGS = registerItem(
        "chainmail_leggings",
        properties -> new ArmorItem(ArmorMaterials.CHAINMAIL, ArmorType.LEGGINGS, properties),
        new Item.Properties().rarity(Rarity.UNCOMMON)
    );
    ...
    public static final Item IRON_CHESTPLATE = registerItem(
        "iron_chestplate", properties -> new ArmorItem(ArmorMaterials.IRON, ArmorType.CHESTPLATE, properties)
    );
    ...
    public static final Item ENDER_DRAGON_SPAWN_EGG = registerItem(
        "ender_dragon_spawn_egg", properties -> new SpawnEggItem(EntityType.ENDER_DRAGON, properties)
    );
    ...
    public static final Item PIGLIN_BRUTE_SPAWN_EGG = registerItem(
        "piglin_brute_spawn_egg", properties -> new SpawnEggItem(EntityType.PIGLIN_BRUTE, properties)
    );
    ...
    public static final Item TRADER_LLAMA_SPAWN_EGG = registerItem(
        "trader_llama_spawn_egg", properties -> new SpawnEggItem(EntityType.TRADER_LLAMA, properties)
    );
    ...
    public static final Item ZOMBIE_HORSE_SPAWN_EGG = registerItem(
        "zombie_horse_spawn_egg", properties -> new SpawnEggItem(EntityType.ZOMBIE_HORSE, properties)
    );
