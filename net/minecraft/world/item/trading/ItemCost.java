...
public record ItemCost(Holder<Item> item, int count, DataComponentPredicate components, ItemStack itemStack) {
    ...
    public ItemCost(Holder<Item> item, int count, DataComponentPredicate componentPredicate) {
        this(item, count, componentPredicate, createStack(item, count, componentPredicate));
    }
