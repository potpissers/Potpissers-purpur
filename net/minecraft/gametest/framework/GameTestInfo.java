...
public class GameTestInfo {
    ...
    public GameTestInfo prepareTestStructure() {
        BlockPos orCalculateNorthwestCorner = this.getOrCalculateNorthwestCorner();
        this.structureBlockEntity = StructureUtils.prepareTestStructure(this, orCalculateNorthwestCorner, this.getRotation(), this.level);
    ...
    public BlockPos getOrCalculateNorthwestCorner() {
        if (this.northWestCorner == null) {
            BoundingBox structureBoundingBox = StructureUtils.getStructureBoundingBox(this.getStructureBlockEntity());
