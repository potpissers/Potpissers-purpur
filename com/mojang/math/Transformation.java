...
public final class Transformation {
    ...
    public Transformation slerp(Transformation transformation, float delta) {
        ...
        Quaternionf leftRotation = this.getLeftRotation();
        Vector3f scale = this.getScale();
        Quaternionf rightRotation = this.getRightRotation();
        translation.lerp(transformation.getTranslation(), delta);
        leftRotation.slerp(transformation.getLeftRotation(), delta);
        scale.lerp(transformation.getScale(), delta);
        rightRotation.slerp(transformation.getRightRotation(), delta);
